...
위 [struct와 함수](#struct와-함수function) 부분의 `PrintValue()` 부분의 맨 앞 철자를 소문자로 바꾼다면 어떻게 될까?
...
```
**위 Plus,Minus 함수를 StructA의 포인터형의 메소드로 선언한 이유는**[Struct와 Function](#struct와-함수function) 참고
